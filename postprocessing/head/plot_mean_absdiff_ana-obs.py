...
for j in range(0,nobs):
  title='avg_abs(analysis-obs)'
  obs_head=obs_data.variables['Head'][0:nsteps,j]
  head_homo_ol=homo_ol_data.variables['head_a'][0:nsteps,id_obs[j]-1]
  head_hete_ol=hete_ol_data.variables['head_a'][0:nsteps,id_obs[j]-1]
  head_homo_h=homo_h_data.variables['head_a'][0:nsteps,id_obs[j]-1]
  head_hete_h=hete_h_data.variables['head_a'][0:nsteps,id_obs[j]-1]
  head_homo_hk=homo_hk_data.variables['head_a'][0:nsteps,id_obs[j]-1]
  head_hete_hk=hete_hk_data.variables['head_a'][0:nsteps,id_obs[j]-1]
...
plt.tight_layout()
#plt.show()
fig_title='avg_abs(analysis-obs)'
