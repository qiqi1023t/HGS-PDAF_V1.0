...
homo_h_file='/p/home/jusers/tang1/jureca/dev_hgs-pdaf/run_scripts/jureca/work/n100_homo_h/001/hgs-flow.da.nc'
hete_h_file='/p/home/jusers/tang1/jureca/dev_hgs-pdaf/run_scripts/jureca/work/n100_hete_h/001/hgs-flow.da.nc'
...
for j in range(0,nobs):
  ...
  diff_homo_ol=head_homo_ol-obs_head
  diff_hete_ol=head_hete_ol-obs_head
  diff_homo_h=head_homo_h-obs_head
  diff_hete_h=head_hete_h-obs_head
  t=np.arange(0,95,1)
  fig=plt.figure()
  plt.plot(t,diff_homo_ol,label='homo_no_DA')
  plt.plot(t,diff_hete_ol,label='hete_no_DA')
  plt.plot(t,diff_homo_h,label='homo_DA')
  plt.plot(t,diff_hete_h,label='hete_DA')
  plt.title(title)
  plt.legend()
  plt.tight_layout()
  #plt.show()
  fig_title='analysis-obs_'+str(j+1)
